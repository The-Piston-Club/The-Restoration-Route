...
import { signUpFlow, logInFlow, googleFlow, guestFlow } from "./profile.js";
...
function bindEvents() {
  ...
  dom.guestBtn.addEventListener("click", guestFlow);
...
async function handleAuthStateChanged(user) {
  ...
  if (claim.state === "valid" && claim.partKey) {
    showStatus(`Log in or continue as a guest to claim your ${getPartLabel(claim.partKey)} stamp.`, "info");
